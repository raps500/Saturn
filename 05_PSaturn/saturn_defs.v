...
`define OP_R6      6'h0e
`define OP_R7      6'h0f
`define OP_DATA    6'h10 // memory port
`define OP_OP_DATA 6'h18 // literal from opcode
...
`define OP_ID      6'h27 // CONFIGID value
`define OP_P       6'h26
...
`define ALU_OP_LSD  5'h08
`define ALU_OP_RSD  5'h09
`define ALU_OP_LSB  5'h0A
`define ALU_OP_RSB  5'h0B
`define ALU_OP_CLS  5'h0C
`define ALU_OP_CRS  5'h10
